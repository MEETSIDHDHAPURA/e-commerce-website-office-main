    ...
    <>
      ...
      <div className="grid xl:grid-cols-9 grid-cols-3 sm:grid-cols-4 sm:gap-2 md:grid-cols-4 gap-1 lg:grid-cols-5 lg:mt-5 xl:px-10 xl:py-3 dark:text-white">
        <div className="mx-auto">
          <button onClick={()=>setData(productDatabase)} className="rounded-full xl:h-20 xl:w-20 h-16 w-16 bg-[#31899f]">
        ...
        <div className="mx-auto">
          <button onClick={()=>filterResult('Phone')} className="rounded-xl xl:h-20 xl:w-20 h-16 w-16 bg-[#31899f] ">
        ...
        <div className="mx-auto">
          <button onClick={()=>filterResult('Earbuds')} className="rounded-xl xl:h-20 xl:w-20 h-16 w-16 bg-[#31899f]">
        ...
        <div className="mx-auto">
          <button onClick={()=>filterResult('Laptop')} className="rounded-xl xl:h-20 xl:w-20 h-16 w-16 bg-[#31899f]">
            <img
              alt=""
              src={Macbook}
        ...
        <div className="mx-auto">
          <button onClick={()=>filterResult('VR')} className="rounded-xl xl:h-20 xl:w-20 h-16 w-16 bg-[#31899f]">
        ...
        <div className="mx-auto">
          <button onClick={()=>filterResult('PS5')} className="rounded-xl xl:h-20 xl:w-20 h-16 w-16 bg-[#31899f]">
        ...
        <div className="mx-auto">
          <button onClick={()=>filterResult('Keybord')} className="rounded-xl xl:h-20 xl:w-20 h-16 w-16 bg-[#31899f]">
        ...
        <div className="mx-auto sm:hidden md:block">
          <button onClick={()=>filterResult('watch')} className="rounded-xl xl:h-20 xl:w-20 h-16 w-16 bg-[#31899f]">
            <img
              alt=""
              src={W1}
              className="xl:w-14 w-10 mx-auto"
            ></img>
          </button>
          <div>
        ...
        <div className="mx-auto">
          <button onClick={()=>filterResult('headphone')} className="rounded-xl xl:h-20 xl:w-20 h-16 w-16 bg-[#31899f]">
            <img
              alt=""
              src={Appleheadphone}
