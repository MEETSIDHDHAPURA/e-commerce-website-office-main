            ...
            <div key={index} className="lg:mx-7 mx-10 my-5">
              <div className="lg:rounded-lg xs:w-72 xs:h-72 rounded-2xl py-1 lg:h-[16rem] lg:w-56 bg-[#000000de] xl:rounded-2xl xl:w-80 xl:h-80 hover:bg-gray-200 hover:duration-1000  dark:bg-gray-200 dark:hover:bg-[#000000de] ">
                <img
                  alt={product.name}
                  src={product.image}
                  className="xs:w-48 xs:ml-10 xs:mt-3 md:ml-10 lg:ml-0 lg:w-[30rem] xl:m-auto xl:w-56 xl:pt-5 drop-shadow-[0_10px_45px_rgba(0,0,0,0.50)] hover:w-[15rem] hover:duration-1000 xl:hover:pt-3 "
                />
              </div>
              ...
              className="bg-gray-800 text-white rounded-full py-2 border-2 px-4 my-4 mx-1 hover:text-black hover:bg-white hover:border-2 inline hover:duration-500"
            >
              Add to cart
            </button>
            </div>
